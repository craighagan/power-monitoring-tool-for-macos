...
#define kMTNotificationNameNegotiatedPowerValue     @"corp.sap.PowerMonitor.NegotiatedPowerValue"
...
#define kMTNotificationKeyNegotiatedPowerValue  @"NegotiatedPowerValue"
